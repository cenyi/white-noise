...
export const metadata: Metadata = {
  title: 'Page Not Found - SereneSoul',
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900 flex items-center justify-center px-4">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
          Like a gentle wave that has reached the shore, this page seems to have wandered off. 
          But don't worry – let's guide you back to tranquility.
        </p>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-8">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-sm">
            <Link href="/en/about" className="text-blue-600 dark:text-blue-400 hover:underline">
              About Us
            </Link>
            <Link href="/en/help" className="text-blue-600 dark:text-blue-400 hover:underline">
              Help & FAQ
            </Link>
            <Link href="/en/contact" className="text-blue-600 dark:text-blue-400 hover:underline">
              Contact
            </Link>
            <Link href="/en/privacy" className="text-blue-600 dark:text-blue-400 hover:underline">
              Privacy Policy
            </Link>
          </div>
        </div>
        ...
        <div className="mt-12 p-6 bg-white/50 dark:bg-gray-800/50 rounded-xl backdrop-blur-sm border border-gray-200 dark:border-gray-700">
          <blockquote className="text-gray-700 dark:text-gray-300 italic">
            "In the midst of chaos, find stillness. In the midst of noise, find silence."
          </blockquote>
